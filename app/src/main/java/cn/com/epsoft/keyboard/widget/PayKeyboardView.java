...
public class PayKeyboardView extends LinearLayout implements OnItemClickListener {
  ...
  public PayKeyboardView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    keyboardRv = (RecyclerView) view.findViewById(R.id.keyboardRv);
    passwordTvs[0] = (TextView) view.findViewById(R.id.pay1Tv);
    passwordTvs[1] = (TextView) view.findViewById(R.id.pay2Tv);
    passwordTvs[2] = (TextView) view.findViewById(R.id.pay3Tv);
    passwordTvs[3] = (TextView) view.findViewById(R.id.pay4Tv);
    passwordTvs[4] = (TextView) view.findViewById(R.id.pay5Tv);
    passwordTvs[5] = (TextView) view.findViewById(R.id.pay6Tv);
